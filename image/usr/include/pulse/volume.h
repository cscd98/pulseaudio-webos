...
typedef enum pa_volume_ramp_type {
    ...
    PA_VOLUME_RAMP_TYPE_MAX = PA_VOLUME_RAMP_TYPE_CUBIC,
} pa_volume_ramp_type_t;
typedef enum pa_volume_fade_type {
    PA_VOLUME_FADE_OUT = 0,
    PA_VOLUME_FADE_IN = 1,
    PA_VOLUME_FADE_MAX = PA_VOLUME_FADE_IN,
}pa_volume_fade_type_t;
...
pa_cvolume_ramp* pa_cvolume_ramp_set(pa_cvolume_ramp *ramp, unsigned channel, pa_volume_ramp_type_t type, long time, pa_volume_t vol, pa_volume_fade_type_t fade_type);
